...
class editProfileART extends StatefulWidget {
  const editProfileART({Key? key}) : super(key: key);
  _editProfileART createState() => _editProfileART();
}

class _editProfileART extends State<editProfileART> {
  ...
  final keyUpdate4 = GlobalKey<FormState>();
  final keyUpdate5 = GlobalKey<FormState>();
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ElevatedButton(
                                onPressed: () {
                                  if (keyUpdate4.currentState!.validate()) {
                                    editKeahlian();
                                  }
                                },
                                child: Text('edit')),
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ElevatedButton(
                                onPressed: () {
                                  if (keyUpdate5.currentState!.validate()) {
                                    editgaji();
                                  }
                                },
                                child: Text('edit')),
  ...
  void editKeahlian() {
    ...
    phoneController.clear();
    print('keahlian Berhasil Update');
  }
  ...
  void editgaji() {
    ...
    phoneController.clear();
    print('Gaji Harapan Berhasil Update');
  }
}
