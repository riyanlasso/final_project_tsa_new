...
import 'package:final_project_tsa_new/listHistoryTransaction.dart';
...
import 'package:final_project_tsa_new/track.dart';

import 'package:firebase_auth/firebase_auth.dart';
import 'package:flutter/material.dart';

class cleanhomecustomer extends StatefulWidget {
  const cleanhomecustomer({Key? key}) : super(key: key);
  _cleanhomecustomer createState() => _cleanhomecustomer();
}

class _cleanhomecustomer extends State<cleanhomecustomer> {
  String uidART = '';
  String uidART2 = '';
  String uidCustomers = '';
  ...
  void initState() {
    ...
    ambilDataCustomers.doc(Customers.uid).get().then((value) {
                ...
                child: IconButton(
                    onPressed: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => trackLocationCustomers()));
                    },
