...
class trackLocationCustomers extends StatefulWidget {
  const trackLocationCustomers({Key? key}) : super(key: key);
  _trackLocationCustomers createState() => _trackLocationCustomers();
}

class _trackLocationCustomers extends State<trackLocationCustomers> {
  var _latitude = '';
  var _longitude = '';
  var _altitude = '';
  var _speed = '';
